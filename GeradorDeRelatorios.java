...
public class GeradorDeRelatorios {
	...
	private Produto[] ordena(int ini, int fim){
		ContextoOrdenacao contexto = new ContextoOrdenacao(algoritmo, ini, fim, produtos, criterio);
	...
	public void geraRelatorio(String arquivoSaida) throws IOException {
		...
		Produto[] produtosOrdenados = ordena(0, produtos.length - 1);
		...
		out.println("</ul>");
		out.println(count + " produtos listados, de um total de " + produtosOrdenados.length + ".");
		out.println("</body>");
		out.println("</html>");
